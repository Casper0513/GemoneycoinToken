                ...
                <div class="tk_counter_inner">
                  ...
                  >
                    ...
                    <span class="progress_label bg-white inline_style_1">
                      <strong> {tokenSale?.tokenSold} GCT </strong>
                    </span>
                    <span class="progress_label bg-white inline_style_2">
                      <strong> {tokenSale?.tokenSaleBalance} GCT </strong>
                    </span>
          ...
          <div class="col-lg-3">
            ...
            <div class="pr_box">
              ...
              <p
                ...
                data-animation-delay="0.8s"
              >
                {tokenSale?.tokenSold} GCT {showPercentage.slice(0, 4)}%
              </p>
            </div>
            <div class="pr_box">
              <h6
