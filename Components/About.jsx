        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 res_md_mt_30 res_sm_mt_20">
            <div class="title_default_light title_border">
              ...
              >
                Gemoneycoin Token is one of the most transformative technologies since
                the invention of the Internet. Gemoney short for Hegomey. Domination, 
                influence, or authority over another, especially by one political group 
                over a society or by one nation over others. We WILL DOMINATE the crypto 
                world one letter at a time! Meet the Gemoneycoin Token!
              </p>
              <p
                class="animation"
                data-animation="fadeInUp"
